...
public class AutoBuyManager {
    ...
    public static void init() {
        ...
        CustomAutoBuyItem[] customAutoBuyItems = {
                ...
                explosiveTrap, stan, explosiveSubstance, universalKey, stealer, expBottle100lvl, farmerSword, mysteriousSummonEgg, winnerPotion, combatFragment, c4, justicePotion
        };
